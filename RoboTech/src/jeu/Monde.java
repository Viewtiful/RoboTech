...
public class Monde implements SlickAdapter {
	...
	/**
	 * Fonction qui gÃ©nÃ©re les plateformes (obstacles) du niveau
	 */
	 ...
	 * 
	 * @param item
	 *            ramassable Ã  ajouter au niveau
	 */
	...
	/**
	 * 
	 * Initialise les diffÃ©rents Ã©lements du niveau
	 * 
	 * @param container
	 * @param game
	 * @param delta
	...
	/**
	 * Met Ã  jour les personnages du niveau qui sont mort, vÃ©rification Ã 
	 * chaque tour
	 * 
	 * @param container
	 * @param game
	...
	/**
	 * Met Ã  jour les balles du niveau qui ont touchÃ©s un element du niveau
	 * pour les dÃ©truires, vÃ©rification Ã  chaque tour
	 * 
	 * @param container
	 * @param game
	 * @param delta
