...
public abstract class Personnage {
	...
	private Body body;
	//le temps durant lequels le personnage a ete considere comme non sur le sol
	...
	public void preUpdate(int delta) {
		...
		//le personnage tombe s'il n'est pas au sol que la velocite sur l'axe des Y et superieur a 0
...
//						System.out.println("2" + events[i].getPoint()+","+events[i].getNormal());
						return true;
					}
				}
			}
